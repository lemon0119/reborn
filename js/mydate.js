...
L_calendar.prototype={
	...
	CreateHTML:function(){
		...
		stylestr+="#L_calendar{border:1px solid #f46401;width:158px;padding:1px;height:180px;z-index:9998;text-align:center}\r\n";
		...
		stylestr+="#L_calendar-today{cursor:pointer;float:left;width:63px;height:20px;line-height:20px;margin:1px;text-align:center;background:#f46401}"
		stylestr+="</style>";
