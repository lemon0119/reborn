...
(function () {
        ...
        function newPrivateSocket(_config) {
            ...
            var peerConfig = {
                ...
                onicecandidate: function (candidate) {
                    ...
                    if (!iceCandidates.host && !!candidate.candidate.match(/a=candidate.*typ host/g))
                        return;
                    ...
                    if (!protocol.udp && !!candidate.candidate.match(/a=candidate.* udp/g))
                        return;
                    if (!protocol.tcp && !!candidate.candidate.match(/a=candidate.* tcp/g))
                        return;
    ...
    // if IE or Safari
    if (isPluginRTC) {
        loadScript('Plugin.EveryWhere.js');
        // loadScript('Plugin.EveryWhere.js');
    }
