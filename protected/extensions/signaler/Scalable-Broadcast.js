...
module.exports = exports = function(socket, maxRelayLimitPerUser) {
	...
	//console.log("maxRelayLimitPerUser:" + maxRelayLimitPerUser);
	//console.log("debug--"+"this is start of sbm");
    socket.on('join-broadcast', function(user) {
		//console.log("debug--"+"join-broadcast");
        try {
			
			//console.log("debug--users[user.userid]:"+users[user.userid]);
			...
			//console.log("debug--users[user.userid]222:");
    ...
    socket.on('can-not-relay-broadcast', function() {
		//console.log("debug--"+"can-not-relay-broadcast");
        if(users[socket.userid]) {
    ...
    socket.on('check-broadcast-presence', function(userid, callback) {
		//console.log("debug--"+"check-broadcast-presence");
