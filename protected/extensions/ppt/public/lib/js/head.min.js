 ...
 */(function (a) {
    ...
    function x(a, b) {
        if (a.state == o)
            return b && b();
        if (a.state == n)
            return k.ready(a.name, b);
        if (a.state == m)
            return a.onpreload.push(function () {
                x(a, b)
            });
    ...
    function u(a) {
        ...
        var b;
        for (var c in a) {
            if (a.hasOwnProperty(c) && a[c].state != o)
                return!1;
            b = !0
        }
        return b
    ...
    if (window.addEventListener)
        a.addEventListener("DOMContentLoaded", z, !1), window.addEventListener("load", z, !1);
