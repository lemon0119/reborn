...
<?php }?>
    ...
    <form class="form-horizontal" method="post" action="./index.php?r=admin/editKeyInfo&&exerciseID=<?php echo $exerciseID;?>" id="myForm"> 
        ...
        <div class="control-group" id="div3" style="<?php if ($count<3) echo "display:none";?>">           
            <div class="controls">               
                <input type="text" name="in7" style="width:150px; height:15px;" id="input7" maxlength="12"value="<?php if ($count>2)echo $optArr[6];?>"><span> ：</span>            
        ...
        <div class="control-group" id="div4" style="<?php if ($count<4) echo "display:none";?>">           
            <div class="controls">               
                <input type="text" name="in10" style="width:150px; height:15px;" id="input10" maxlength="12"value="<?php if ($count>3)echo $optArr[9];?>"><span> ：</span>                
        ...
        <div class="control-group" id="div5" style="<?php if ($count<5) echo "display:none";?>">            
            <div class="controls">               
                <input type="text" name="in13" style="width:150px; height:15px;" id="input13" maxlength="12"value="<?php if ($count>4) echo $optArr[12];?>"><span> ：</span>            
    ...
    <div class="control-group" style="display: none"  id="div6" style="<?php if ($count<6) echo "display:none";?>">           
            <div class="controls">               
                <input type="text" name="in16" style="width:150px; height:15px;" id="input13" maxlength="12"value="<?php if ($count>5) echo $optArr[15];?>"><span> ：</span>         
    ...
    <div class="control-group" style="display: none"  id="div7" style="<?php if ($count<7) echo "display:none";?>">           
            <div class="controls">               
                <input type="text" name="in19" style="width:150px; height:15px;" id="input13" maxlength="12"value="<?php if ($count>6)echo $optArr[18];?>"><span> ：</span>     
    ...
    <div class="control-group" style="display: none"  id="div8" style="<?php if ($count<8) echo "display:none";?>">           
            <div class="controls">               
                <input type="text" name="in22" style="width:150px; height:15px;" id="input13" maxlength="12"value="<?php if ($count>7)echo $optArr[21];?>"><span> ：</span>                
    ...
    <div class="control-group"  style="display: none" id="div9" style="<?php if ($count<9) echo "display:none";?>">           
            <div class="controls">               
                <input type="text" name="in25" style="width:150px; height:15px;" id="input13" maxlength="12"value="<?php if ($count>8)echo $optArr[24];?>"><span> ：</span>           
    ...
    <div class="control-group"  style="display: none" id="div10" style="<?php if ($count<10) echo "display:none";?>">           
            <div class="controls">               
                <input type="text" name="in28" style="width:150px; height:15px;" id="input13" maxlength="12"value="<?php if ($count>9)echo $optArr[27];?>"><span> ：</span>               
