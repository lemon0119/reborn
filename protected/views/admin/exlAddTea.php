  ...
  echo 'style="color: red"';}else{echo 'style="color: green"';}?>><?php echo $stu_fail[3]; ?></td>  
			...
			<div class="form-actions">
				<input type="submit" class="btn btn-primary" value="添加" />&nbsp;&nbsp;<a
					href="./index.php?r=admin/AddTea" class="btn btn-primary">逐个添加</a>&nbsp;&nbsp;<a
					href="./index.php?r=admin/teaLst" class="btn btn-primary">返回</a>
			</div>
		</fieldset>
	</form>
</div>
            ...
            if(isset($result)){
                if($result==='不是Excel文件'){
                    ...
                    echo 'window.wxc.xcConfirm("'.$result.'",window.wxc.xcConfirm.typeEnum.error)';
                     ...
                     echo 'window.wxc.xcConfirm("成功导入了'.$result.'位老师,'.$count_fail.'位老师没有导入", window.wxc.xcConfirm.typeEnum.success)';
                }else {
