        ...
        <div class="well" style="padding: 8px 0;">
                ...
                <form action="./index.php?r=admin/searchKey" method="post">
                        ...
                        <li style="margin-top:10px">
                                ...
                                <button href="./index.php?r=admin/AddKey" class="btn_add"></button>
                        </li>
                </form>
                        <li class="divider"></li>
            ...
            <tr>
                ...
                <tbody>        
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./index.php?r=admin/editKey&&exerciseID=<?php echo $model['exerciseID'];?>&&action=look"><img src="<?php echo IMG_URL; ?>detail.png"></a>
                            <a href="./index.php?r=admin/editKey&&exerciseID=<?php echo $model['exerciseID'];?>"><img src="<?php echo IMG_URL; ?>edit.png"></a>
