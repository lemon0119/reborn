        ...
        <div class="well" style="padding: 8px 0;">
                ...
                <form action="./index.php?r=admin/searchLook" method="post">
                        ...
                        <li style="margin-top:10px">
                                ...
                                <a href="./index.php?r=admin/AddLook" class="btn">添加</a>
                        </li>
                </form>
                        <li class="divider"></li>
            ...
            <tr>
                ...
                <tbody>        
                    ...
                    <tr>
                        ...
                        <td><?php  if(strlen($model['content'])<=27)
                                        echo $model['content'];
                                    else
                                        echo substr($model['content'], 0, 27)."...";
                                        ?></td>
                       ...
                       <a href="./index.php?r=admin/deleteLook&&exerciseID=<?php echo $model['exerciseID'];?>"><img src="<?php echo IMG_URL; ?>delete.png">删除</a>
                        </td>
                    </tr>            
                    <?php endforeach;?> 
                </tbody>
