...
<a href="./index.php?r=admin/revokeTea" id="submit"><img title="撤销" src="<?php echo IMG_URL; ?>reborn.png"></a>
    <a href="./index.php?r=admin/confirmTeaPass" id="submit"><img title="彻底删除" src="<?php echo IMG_URL; ?>delete.png"></a>
