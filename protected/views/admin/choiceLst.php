                ...
                <form action="./index.php?r=admin/searchStu" method="post">
                        <li>
                                <select name="type" style="width: 185px">
                                        <option value="userID" selected="selected">编号</option>
                                        <option value="courseID" selected="selected">课程号</option>
                                </select>
                        </li>
                        <li>
                        ...
                        <li class="active"><a href="./index.php?r=admin/stuLst"><i class="icon-font"></i> 选择</a></li>
                        <li ><a href="./index.php?r=admin/addStu"><i class="icon-text-width"></i> 填空</a></li>
                        <li ><a href="./index.php?r=admin/recycleStu"><i class="icon-align-left"></i> 简答</a></li>
                        <li class="divider"></li>
                        <li class="nav-header">打字练习</li>
                        <li ><a href="./index.php?r=admin/stuLst"><i class="icon-th"></i> 键位练习</a></li>
                        <li ><a href="./index.php?r=admin/addStu"><i class="icon-eye-open"></i> 看打练习</a></li>
                        <li ><a href="./index.php?r=admin/recycleStu"><i class="icon-headphones"></i> 听打练习</a></li>
                </ul>
        </div>
</div>
