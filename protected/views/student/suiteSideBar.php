...
<div class="span3">
        <div class="well" style="padding: 8px 0;">
                <ul class="nav nav-list">
                        ...
                        <li id="li-choice">
                            <a href="./index.php?r=student/choice&&cent=<?php $arg= implode(',', $cent);echo $arg;?>"><i class="icon-font"></i> 选 择 题</a>
                                <div id= "container" style="width:50%;height: 5px;border:1px solid black;">
                        ...
                        <li id="li-filling">
                            <a href="./index.php?r=student/filling&&cent=<?php $arg= implode(',', $cent);echo $arg;?>"><i class="icon-text-width"></i> 填 空 题</a>
                                <div id= "container" style="width:50%;height: 5px;border:1px solid black;">
                                    <div id="progress-bar" style="width:<?php echo $cent[4];?>;background-color: red;height:5px;">
                                    </div>
                                </div>  
                                    <?php echo $cent[4];?>k
                        ...
                        <li id="li-question">
                            <a href="./index.php?r=student/question&&cent=<?php $arg= implode(',', $cent);echo $arg;?>"><i class="icon-align-left"></i> 简 答 题</a>
                                    <div id= "container" style="width:50%;height: 5px;border:1px solid black;">
                                        <div id="progress-bar" style="width:<?php echo $cent[5];?>;background-color: red;height:5px;">
