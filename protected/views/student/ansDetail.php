...
<script src="<?php echo EXER_JS_URL;?>accounting.js"></script>
<meta charset="utf-8">
<input id="content" type="hidden" value="<?php echo $exer['content'];?>">
<div class="span9">
...
<?php
    function encodeHtml($str){
        //str_replace($str,chr(13)&chr(10),"<br/>");
        //str_replace($str,chr(32),"&nbsp;");
        return $str;
    }
