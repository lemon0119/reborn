        ...
        <div style="display: none" id="id_classExerciseLesson">
              <ul class="nav nav-list"> 
                <?php foreach ($array_lesson as $lesson): ?>
                  <li style="margin:5px"><div ><a href="#" class="ahover" onclick="getClassExer(<?php echo $lesson['lessonID']; ?>)"><i style="margin-top:-4px" class="icon-knowlage"></i>&nbsp;<?php echo $lesson['lessonName']; ?></a></div></li>                  
              <?php endforeach; ?> 
              </ul>
        </div>
