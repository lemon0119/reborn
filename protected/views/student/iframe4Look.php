...
<body style="background-image: none;background-color: #fff">
    <div id="span" class="hero-unit" align="center">
        <div style="width: 700px">
            <button class="fl btn" id="pause">暂停统计</button><button id="toggle" style="margin-left:30px;" class="btn fr">展开</button><button id="close_exercise"  style="margin-left:30px;" class="fr btn btn-primary">刷新</button>
        </div>
        <div id="Analysis">
