                    ...
                    <?php if (count($exercise['choice']) != 0 && count($exercise['filling']) != 0 && count($exercise['question']) != 0) { ?>
                        ...
                        <?php foreach ($exercise['key'] as $keyType) :?>
                            <li id="li-key-<?php echo $keyType['exerciseID'];?>">
                                <a href="./index.php?r=student/ansKeyType&&exerID=<?php echo $keyType['exerciseID'];?>" title="<?php echo $keyType['title']; ?>">
                                        <i class="icon-th"></i>
                        ...
                        <?php foreach ($exercise['look'] as $lookType) :?>
                            <li id="li-look-<?php echo $lookType['exerciseID'];?>">
                                <a href="./index.php?r=student/ansLookType&&type=look&&exerID=<?php echo $lookType['exerciseID'];?>" title="<?php echo $lookType['title']; ?>">
                        ...
                        <li id="li-listen-<?php echo $listenType['exerciseID'];?>">
                                <a href="./index.php?r=student/ansLookType&&type=listen&&exerID=<?php echo $listenType['exerciseID'];?>" title="<?php echo $listenType['title']; ?>">
