        ...
        <div class="well" style="padding: 8px 0;">
                ...
                <form action="./index.php?r=teacher/searchKey" method="post">
                        ...
                        <li style="margin-top:10px">
                                ...
                                <button href="./index.php?r=teacher/AddKey" class="btn_add"></buton>
                        </li>
                </form>
                        <li class="divider"></li>
            ...
            <tr>
                ...
                <tbody>        
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./index.php?r=teacher/editKey&&exerciseID=<?php echo $model['exerciseID'];?>&&action=look"><img src="<?php echo IMG_URL; ?>detail.png"></a>
                          <?php if($model['createPerson'] == Yii::app()->session['userid_now']){?>
                            <a href="./index.php?r=teacher/editKey&&exerciseID=<?php echo $model['exerciseID'];?>"><img src="<?php echo IMG_URL; ?>edit.png"></a>
