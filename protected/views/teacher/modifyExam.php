...
<div class="span9">
    <iframe src="./index.php?r=teacher/ToOwnExam&&type=<?php echo $type; ?>&&examID=<?php echo $exam['examID']; ?>" id="iframe1" frameborder="0"  scrolling="no" width="770px" height="350px" name="iframe1"></iframe>
