...
<div class="span9">
    <iframe src="./index.php?r=teacher/ToOwnExam&&type=<?php echo $type; ?>&&examID=<?php echo $exam['examID']; ?>" id="iframe1" frameborder="0"  scrolling="no" width="700px" height="400px" name="iframe1"></iframe>

    <iframe src="./index.php?r=teacher/ToAllExam&&type=<?php echo $type; ?>&&examID=<?php echo $exam['examID']; ?>" id="iframe2" frameborder="0" scrolling="no" width="700px" height="400px" name="iframe2"></iframe>
