            ...
            <ul class="nav nav-list">
                <center>
                    <table>
                        ...
                        <tr><td>开始时间: 
                                <div class="inline layinput"><input  style="width:233px;" placeholder="选择开始时间" name="startTime" id="startTime" value="<?php echo $exam['begintime'] ?> " onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" ></div>       
                            </td></tr>
                        <tr><td>结束时间:
...
<div class="span9">
    <iframe src="./index.php?r=teacher/ToOwnExam&&type=<?php echo $type; ?>&&examID=<?php echo $exam['examID']; ?>" id="iframe1" frameborder="0"  scrolling="no" width="770px" height="400px" name="iframe1"></iframe>

    <iframe src="./index.php?r=teacher/ToAllExam&&type=<?php echo $type; ?>&&examID=<?php echo $exam['examID']; ?>" id="iframe2" frameborder="0" scrolling="no" width="770px" height="400px" name="iframe2"></iframe>
