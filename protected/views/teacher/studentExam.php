    ...
    <div class="well" style="padding: 8px 0;">
        <ul class="nav nav-list">
           ...
           <?php foreach ($array_class as $class):?>
            <li <?php if($class['classID'] == $selectClassID) echo "class='active'";?>><a href="./index.php?r=teacher/StuExam&&selectClassID=<?php echo $class['classID']?>"><i class="icon-list" style="position:relative;bottom:7px;left:"></i><?php echo $class['className']?></a></li>
          <?php endforeach;?>  
