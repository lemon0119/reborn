...
<div class="span9">
    ...
    <div id ="voice-table" style="height: 500px;overflow:scroll;width: 100%;"></div>
...
<script>
    ...
    $("#voice-table").load("./index.php?r=teacher/voiceTable&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&isnew=0");
