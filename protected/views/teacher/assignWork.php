        ...
        <tbody>        
            ...
            foreach ($array_allsuite as $suite):
                ...
                <tr>
                    ...
                    <td>
                        <a href="./index.php?r=teacher/seeWork&&suiteID=<?php echo $suite['suiteID']; ?>"><img src="<?php echo IMG_URL; ?>detail.png"></a>

                        <a href="./index.php?r=teacher/modifyWork&&suiteID=<?php echo $suite['suiteID']; ?>&&type=choice"><img src="<?php echo IMG_URL; ?>edit.png"></a>
                        <a href="#" onclick="dele(<?php echo $suite['suiteID']; ?>,<?php echo $pages->currentPage + 1; ?>)"><img src="<?php echo IMG_URL; ?>delete.png"></a>
