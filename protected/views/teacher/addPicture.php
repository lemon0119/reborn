...
<div class="span9" style="position: relative; left: 20px;margin-left: 300px;">
    ...
    <form class="form-horizontal" id="myForm"  method="post" action="./index.php?r=teacher/addPictureNew&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&isnew=1" enctype="multipart/form-data"> 
...
<script>
    ...
    $("#picture-table").load("./index.php?r=teacher/pictureTable&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&isnew=1");
