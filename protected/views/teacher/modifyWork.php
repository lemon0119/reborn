<div class="span3">
    <div class="well" style="padding: 8px 0;">
        <ul class="nav nav-list">
            <li <?php if($type == "choice") echo "class='active'" ?>><a href="./index.php?r=teacher/ModifyChoiceWork&&suiteID=<?php echo $suite['suiteID']?>"><i class="icon-font"></i> 选择</a></li>
                        <li <?php if($type == "filling") echo "class='active'" ?>><a href="./index.php?r=teacher/ModifyFillingWork&&suiteID=<?php echo $suite['suiteID']?>"><i class="icon-text-width"></i> 填空</a></li>
                        <li <?php if($type == "question") echo "class='active'" ?>><a href="./index.php?r=teacher/ModifyQuestionWork&&suiteID=<?php echo $suite['suiteID']?>"><i class="icon-align-left"></i> 简答</a></li>
                        <li <?php if($type == "key") echo "class='active'" ?>><a href="./index.php?r=teacher/ModifyWork"><i class="icon-th"></i> 键位练习</a></li>
                        <li <?php if($type == "look") echo "class='active'" ?>><a href="./index.php?r=teacher/ModifyWork"><i class="icon-eye-open"></i> 看打练习</a></li>
                        <li <?php if($type == "listen") echo "class='active'" ?>><a href="./index.php?r=teacher/ModifyWork"><i class="icon-headphones"></i> 听打练习</a></li>                           
        </ul>
            ...
            <tr>
                ...
                <tbody>        
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#"><img src="<?php echo IMG_URL; ?>detail.png">添加</a>
...
function dele( type ,exerciseID,suiteID){
      if(confirm("您确定删除吗？")){
          window.location.href = "./index.php?r=teacher/deleteSuite&&exerciseID=" + exerciseID + "&&type=" + type + "&&suiteID=" + suiteID;
      }
  }
</script>
