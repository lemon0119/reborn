...
<table class="table table-bordered table-striped" >
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>管理员</td>
            <td>
                <a href="./index.php?r=teacher/lookTxt&&txt=<?php echo iconv("gb2312","UTF-8",$file);?>&&vdir=<?php echo $dir;?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&ispublic=0&&isnew=0" title="查看"><img src="<?php echo IMG_URL; ?>detail.png"></a>
...
<!--        <tr>
            ...
            <td>公共</td>
            <td>
                <a href="./index.php?r=teacher/looktxt&&txt=<?php echo iconv("gb2312","UTF-8",$file);?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&ispublic=1&&isnew=0"><img src="<?php echo IMG_URL; ?>detail.png" title="查看"></a>
