            ...
            <ul class="nav nav-list">
                        <li style="margin-top:10px">
                            <?php if(isset($_GET['nobar'])){ ?>
                                 ...
                                 <button  style="height: 35px;margin-left: 10px" onclick="location.href='./index.php?r=teacher/modifyClassExercise&&nobar=yes&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>&&type=look'" class="btn_4big">添 加</button>
                            <?php }else{ ?>
                                ...
                                <button  style="height: 35px;margin-left: 10px" onclick="location.href='./index.php?r=teacher/modifyClassExercise&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>&&type=look'" class="btn_4big">添 加</button>
                            <?php }?>
...
<!--                        <td class="font-center" style="width: 50px"><?php //echo $model['exerciseID'];?></td>-->
                  ...
                  <td class="font-center" style="width: 100px">
                             <a href="./index.php?r=teacher/editLook4ClassExercise&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>&&exerciseID=<?php echo $model['exerciseID'];?>&&action=look"><img title="查看" src="<?php echo IMG_URL; ?>detail.png"></a>
                            <a href="./index.php?r=teacher/editLook4ClassExercise&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>&&exerciseID=<?php echo $model['exerciseID'];?>"><img title="编辑" src="<?php echo IMG_URL; ?>edit.png"></a>
...
<script>
   ...
   function dele(exerciseID){
      ...
      var option = {
						...
						btn: parseInt("0011",2),
						onOk: function(){
							 window.location.href = "./index.php?r=teacher/ClassExercise4Look&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>&&exerciseID="+exerciseID+"&&delete=delete";
						}
					}
