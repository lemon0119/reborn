            ...
            <ul class="nav nav-list">
                        <li style="margin-top:10px">
                            <?php if(isset($_GET['nobar'])){ ?>
                                 ...
                                 <button  style="height: 35px;right: 5px" onclick="location.href='./index.php?r=teacher/addLook4ClassExercise&&nobar=yes&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>'" class="btn_add fr"></button>
                            <?php }else{ ?>
                                ...
                                <button  style="height: 35px;right: 5px" onclick="location.href='./index.php?r=teacher/addLook4ClassExercise&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>'" class="btn_add fr"></button>
                            <?php }?>
