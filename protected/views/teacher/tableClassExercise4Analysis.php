...
<body style="background-image: none;background-color: #fff">
    <div style="overflow: hidden" id="title"><select id="selectExercise" class="selectBox" onchange="optionOnclick()"></select><button style="margin: 10px"  class="fr btn" id="back">返回上级</button><button onclick="next()" style="margin: 10px" id="next" class="fr btn btn-primary" <?php if(count($AllIsOpen)<1){echo 'disabled="disabled"';}?>>下一题</button>
