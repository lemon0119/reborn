...
//    }
    ...
    function next(){
        ...
        console.log("c"+count+"c"+exericseID);
        checkAnalysis(exericseID);
        if(count == allExercise.length-1){
