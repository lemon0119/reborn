...
<script>
   ...
   function dele(exerciseID){
      ...
      var option = {
						...
						btn: parseInt("0011",2),
						onOk: function(){
							 window.location.href = "./index.php?r=teacher/ClassExercise4Listen&&classID=<?php echo $_GET['classID'];?>&&progress=<?php echo $_GET['progress'];?>&&on=<?php echo $_GET['on'];?>&&exerciseID=" + exerciseID+"&&delete=delete";
						}
					}
