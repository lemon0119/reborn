    ...
    <form class="form-horizontal" method="post" action="./index.php?r=teacher/editKeyInfo&&exerciseID=<?php echo $exerciseID;?>" id="myForm"> 
        ...
        <div class="control-group">
            ...
            <div class="controls">               
                ...
                <a class="btn btn-primary"  <?php if(!isset($action)){ echo 'onclick="addIn()"';  }?>><i class="icon-plus icon-white" ></i></a> <a class="btn btn-primary" <?php if(!isset($action)){ echo 'onclick="deleteIn()" '; }?>><i class="icon-minus icon-white"></i></a>
            </div>             
        </div>
