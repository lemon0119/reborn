...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>管理员</td>
            <td>
                <a href="./index.php?r=teacher/lookvoice&&voice=<?php echo iconv("gb2312","UTF-8",$file);?>&&vdir=<?php echo $dir;?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&ispublic=0&&isnew=1" title="查看"><img src="<?php echo IMG_URL; ?>detail.png"></a>
        ...
        <tr>
            ...
            <td>自己</td>
            <td>
                <a href="./index.php?r=teacher/lookVoice&&voice=<?php echo iconv("gb2312","UTF-8",$file);?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&ispublic=0&&isnew=1"><img src="<?php echo IMG_URL; ?>detail.png" title="查看"></a>
        ...
        <tr>
            ...
            <td>公共</td>
            <td>
                <a href="./index.php?r=teacher/lookVoice&&voice=<?php echo iconv("gb2312","UTF-8",$file);?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&ispublic=1&&isnew=1"><img src="<?php echo IMG_URL; ?>detail.png" title="查看"></a>
                <a href="<?php echo "$vdir".iconv("gb2312","UTF-8",$file);?>" target="_blank" download="<?php echo Resourse::model()->getOriName(iconv("gb2312","UTF-8",$file));?>"><img src="<?php echo IMG_URL; ?>icon_download.png" title="下载"></a>
...
//    });
    function del(voice2,classID2,progress2,on2,ispublic){
        var option = {
                ...
                btn: parseInt("0011",2),
                onOk: function(){
                        window.location.href="./index.php?r=teacher/deleteVoice&&voice="+voice2+"&&classID="+classID2+"&&progress="+progress2+"&&on="+on2+"&&ispublic="+ispublic+"&&isnew="+'1';
                }
        }
