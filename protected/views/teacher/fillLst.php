...
<div class="span3">
    <div class="well" style="padding: 8px 0;">
        <ul class="nav nav-list">
            ...
            <li class="active"><a href="./index.php?r=teacher/fillLst"><i class="icon-text-width" style="position:relative;bottom:5px;left:"></i> 填空</a></li>
...
<div class="span9">
            ...
            <?php foreach ($fillLst as $model): ?>
                <tr>
                    ...
                    <td class="font-center"><?php
                        if (Tool::clength($model['requirements']) <= 10)
    ...
    <?php } else { ?>
                            <a href="./index.php?r=teacher/copyFill&&code=<?php echo $code; ?>&&exerciseID=<?php echo $model['exerciseID']; ?>"><img title="复制一份" src="<?php echo IMG_URL; ?>copy.png"></a>
                <?php } ?>
                    </td>
                </tr>            
<?php endforeach; ?> 
    ...
    $(document).ready(function () {
        ...
        if($tip=='此题目已经被占用!'){
            window.wxc.xcConfirm($tip, window.wxc.xcConfirm.typeEnum.error,{
                onOk:function (){
                     window.location.href="./index.php?r=teacher/fillLst";  
                }
            });
        }
