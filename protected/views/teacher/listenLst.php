        ...
        <div class="well" style="padding: 8px 0;">
                ...
                <form action="./index.php?r=teacher/searchListen" method="post">
                        ...
                        <li style="margin-top:10px">
                                ...
                                <button href="./index.php?r=teacher/addListen" class="btn_add"></button>
                        </li>
                </form>
                        <li class="divider"></li>
            ...
            <tr>
                ...
                <tbody>        
                    ...
                    <tr>
                        ...
                        <td>
                             <a href="./index.php?r=teacher/editListen&&exerciseID=<?php echo $model['exerciseID'];?>&&action=look"><img src="<?php echo IMG_URL; ?>detail.png"></a>
                          <?php if($model['createPerson'] == Yii::app()->session['userid_now']){?>
                            <a href="./index.php?r=teacher/editListen&&exerciseID=<?php echo $model['exerciseID'];?>"><img src="<?php echo IMG_URL; ?>edit.png"></a>
...
<script>
    ...
    var result = <?php  if(isset($result)) echo "'$result'"; else echo'no';?>;
    if(result === '1')
        alert('复制选择题成功！');
    else
    {if(result === '0')
