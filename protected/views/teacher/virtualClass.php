                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid" style="margin-bottom: 20px;">
                        <div class="span6" style="height:750px;overflow-y:auto;overflow-x:hidden;" id="display_zhibo" >
                            <script src="http://192.168.101.235:8888/socketio.js"></script>
                        ...
                        <section class="experiment">
                               <?php if(isset($info)){ ?>
                                    <section id="zhibo">
                                        <span>
                                            <!--私有课堂 <a href="/video-conferencing/" target="_blank" title="Open this link in new tab. Then your conference room will be private!"><code><strong id="unique-token">#123456789</strong></code></a>-->
                                            <code>创建课堂</code>
                                        </span>

                                        <input type="text" id="conference-name" value="<?php echo Yii::app()->user->name;?>"  />
                                        <button id="setup-new-room" class="btn btn-primary">创建</button>
                                    </section>
                               <?php }?>
                        ...
                        <div id="controll2">
                            ...
                            <?php if(isset($info)){ ?>
                            <div>
                           <button onclick="" id="send"  class="btn btn-primary">播放/暂停</button> 
                            </div>
                           <?php } ?>
                        </div>
                     <!--点播end-->
