    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="./index.php?r=teacher/deleteVideo&&video=<?php echo iconv("gb2312","UTF-8",$file);?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>" id="dele"><img src="<?php echo IMG_URL; ?>delete.png" title="删除"></a>
            </td>
        </tr>
        <?php     
                    } 
