...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>管理员</td>
            <td>
                <a href="./index.php?r=teacher/lookVideo&&video=<?php echo iconv("gb2312","UTF-8",$file);?>&&vdir=<?php echo $dir;?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&ispublic=0" title="查看"><img src="<?php echo IMG_URL; ?>detail.png"></a>
        ...
        <tr>
            ...
            <td>自己</td>
            <td>
                <a href="./index.php?r=teacher/lookVideo&&video=<?php echo iconv("gb2312","UTF-8",$file);?>&&classID=<?php echo $classID;?>&&progress=<?php echo $progress;?>&&on=<?php echo $on;?>&&ispublic=0"><img src="<?php echo IMG_URL; ?>detail.png" title="查看"></a>
...
<script>
    function del(video2,classID2,progress2,on2,ispublic){  
        var option = {
                ...
                btn: parseInt("0011",2),
                onOk: function(){
                        window.location.href="./index.php?r=teacher/deleteVideo&&video="+video2+"&&classID="+classID2+"&&progress="+progress2+"&&on="+on2+"&&ispublic="+ispublic;
                }
        }
